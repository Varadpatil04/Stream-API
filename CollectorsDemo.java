...
public class CollectorsDemo {
        ...
        public static void main(String[] args) {
            ...
            List<String> l = Arrays.asList("Varad","Raj","Nirmal","Kaustubh","Hardik");
            System.out.println(l.stream().collect(Collectors.groupingBy(x->x.length())));
            ...
            System.out.println(Arrays.stream(sentence.split(" ")).collect(Collectors.groupingBy(x -> x.startsWith("h"))));
